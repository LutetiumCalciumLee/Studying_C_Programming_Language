...
C는 워드 프로세서, 스프레드시트, 게임, 모바일 앱 등 다양한 소프트웨어 제작에 널리 사용되는 강력한 프로그래밍 언어임.  

컴퓨터 프로그래머에 의해 개발되어 간단한 계산기부터 복잡한 애플리케이션까지 활용됨.
...
- **이식성:**  
  C 코드의 다양한 운영체제(Windows, Unix 등) 실행 가능성  

- **하드웨어 접근성:**  
  저수준 접근 가능성으로 인한 시스템 프로그래밍 적합성  

- **단순 문법:**  
  명확하고 간결한 문법에 의한 학습 용이성  

- **확장성:**  
  C 학습을 통한 기타 프로그래밍 언어 습득 용이성  

## C 프로그램 작성 및 실행 절차  

### 1. 프로그램 코딩  
- 컴파일러가 이해·처리 가능한 명령어 작성 행위  
- 인간 전용 이해용 소스 코드 작성 단계  

### 2. 컴파일 및 링크  
- **컴파일:** 인간이 읽는 소스 파일을 컴퓨터가 인식하는 목적 파일로 변환하는 과정  
- **링크:** 여러 목적 파일의 단일 실행 파일 결합 과정  

### 3. 프로그램 실행  
- 생성된 실행 파일(.exe)의 실행 및 결과 확인  

***

## 프로젝트 환경  

- **Visual Studio**를 이용한 C 언어 파일 작성  
